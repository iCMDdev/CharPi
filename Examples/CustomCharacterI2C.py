...
display.newCharacter([0b00000,
                      ...
                      0b00100,
                      0b11111,
                      0b00000], 1) # Created a tree at address 1
...
display.writeString(["Writing some custom characters (again): ", 0, 1, "\nHow cool is that!?"], lineNum = 2, columnNum = 0, delay = 0.1, newlineDelay = 0.3)

"""
Useful things to know:
1) You can only create 8 characters (hardware limit)
2) Each custom character is saved by the display at a specific address in it's memory
3) The custom character's memory address can range from 0 to 8 for 5x8 characters, and 4 for 5x10. You'll need use this address to save a new
